    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skilled_nursing', to='a_blue_rainbow.providers')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews', models.TextField()),
                ('official_website', models.CharField(max_length=255)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hospice', to='a_blue_rainbow.providers')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews', models.TextField()),
                ('official_website', models.CharField(max_length=255)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_health', to='a_blue_rainbow.providers')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviews', models.TextField()),
                ('official_website', models.CharField(max_length=255)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assisted_living', to='a_blue_rainbow.providers')),
            ],
        ),
    ]
